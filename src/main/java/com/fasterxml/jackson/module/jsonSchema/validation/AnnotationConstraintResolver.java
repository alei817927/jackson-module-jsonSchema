...
import com.fasterxml.jackson.module.jsonSchema.annotation.MeicSchema;
...
public class AnnotationConstraintResolver implements ValidationConstraintResolver {
  ...
  private MeicSchema getMeicSchemaAnnotation(BeanProperty prop) {
    return prop.getAnnotation(MeicSchema.class);
  }

  @Override
  public String getTitle(BeanProperty prop) {
    MeicSchema meicSchema = getMeicSchemaAnnotation(prop);
    return meicSchema != null ? meicSchema.title() : null;
  }
